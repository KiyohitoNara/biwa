...
class ReorderMediaUseCaseTest {
    ...
    @Test
    fun `execute assigns 0-based indices as sort_order`() =
        runTest {
    ...
    @Test
    fun `execute calls updateSortOrder for every id`() =
        runTest {
    ...
    @Test
    fun `execute with single item sets sortOrder to 0`() =
        runTest {
    ...
    @Test
    fun `execute with empty list does nothing`() =
        runTest {
