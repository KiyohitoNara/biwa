...
class AddMediaUseCaseTest {
    ...
    @Test
    fun `execute copies file to internal storage`() =
        runTest {
    ...
    @Test
    fun `execute saves item to repository`() =
        runTest {
    ...
    @Test
    fun `execute returns MediaItem with resolved filePath`() =
        runTest {
    ...
    @Test
    fun `execute returns MediaItem with addedAt from clock`() =
        runTest {
            val result = useCase.execute(videoRequest())
    ...
    @Test
    fun `execute returns MediaItem with null thumbnailPath and lastViewedAt`() =
        runTest {
            val result = useCase.execute(videoRequest())
    ...
    @Test
    fun `execute returns MediaItem preserving request fields`() =
        runTest {
            val request = videoRequest()
    ...
    @Test
    fun `execute generates non-blank id`() =
        runTest {
            val result = useCase.execute(videoRequest())
    ...
    @Test
    fun `execute generates unique ids across calls`() =
        runTest {
    ...
    @Test
    fun `execute supports VIDEO media type`() =
        runTest {
    ...
    @Test
    fun `execute supports GIF media type`() =
        runTest {
    ...
    @Test
    fun `execute supports PHOTO media type`() =
        runTest {
    ...
    @Test
    fun `execute persists returned item to repository with matching id`() =
        runTest {
            val result = useCase.execute(videoRequest())
