...
class GetAllMediaUseCaseTest {
    ...
    @Test
    fun `execute emits empty list when no items exist`() =
        runTest {
    ...
    @Test
    fun `execute emits list after item is added`() =
        runTest {
    ...
    @Test
    fun `execute reflects items added after subscription`() =
        runTest {
    ...
    @Test
    fun `execute reflects item removal`() =
        runTest {
            fakeRepository.addMedia(videoItem())
    ...
    @Test
    fun `execute returns items in repository order`() =
        runTest {
