...
class GetAllPhotosUseCaseTest {
    ...
    @Test
    fun `execute emits empty list when library is empty`() =
        runTest {
    ...
    @Test
    fun `execute filters out VIDEO items`() =
        runTest {
    ...
    @Test
    fun `execute filters out GIF items`() =
        runTest {
    ...
    @Test
    fun `execute returns only PHOTO items`() =
        runTest {
            fakeRepository.addMedia(mediaItem("v", MediaType.VIDEO))
            fakeRepository.addMedia(mediaItem("g", MediaType.GIF))
    ...
    @Test
    fun `execute preserves repository ordering`() =
        runTest {
            fakeItems.value =
                listOf(
    ...
    @Test
    fun `execute reacts to new photos added to library`() =
        runTest {
            fakeRepository.addMedia(mediaItem("p1", MediaType.PHOTO))
