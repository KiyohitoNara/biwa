...
class UpdateLastViewedAtUseCaseTest {
    ...
    @Test
    fun `execute passes clock timestamp to repository`() =
        runTest {
    ...
    @Test
    fun `execute uses current clock value each call`() =
        runTest {
            var time = 1_000L
    ...
    @Test
    fun `execute does not throw for non-existent id`() =
        runTest {
    ...
    @Test
    fun `execute passes correct id to repository`() =
        runTest {
