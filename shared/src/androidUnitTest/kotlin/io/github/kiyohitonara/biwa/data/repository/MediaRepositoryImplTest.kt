...
class MediaRepositoryImplTest {
    ...
    @Test
    fun `getAllMedia emits empty list when no items exist`() =
        runTest {
    ...
    @Test
    fun `addMedia inserts item and getAllMedia emits it`() =
        runTest {
    ...
    @Test
    fun `addMedia preserves all fields`() =
        runTest {
            val item = videoItem()
    ...
    @Test
    fun `addMedia supports VIDEO, GIF, and PHOTO types`() =
        runTest {
    ...
    @Test
    fun `getMediaById returns item when it exists`() =
        runTest {
            repository.addMedia(videoItem())
    ...
    @Test
    fun `getMediaById returns null when item does not exist`() =
        runTest {
    ...
    @Test
    fun `deleteMedia removes item from library`() =
        runTest {
            repository.addMedia(videoItem())
    ...
    @Test
    fun `deleteMedia on nonexistent id does not throw`() =
        runTest {
    ...
    @Test
    fun `updateLastViewedAt persists timestamp`() =
        runTest {
            repository.addMedia(videoItem())
    ...
    @Test
    fun `updateThumbnailPath persists path`() =
        runTest {
            repository.addMedia(videoItem())
    ...
    @Test
    fun `updateSortOrder persists new order`() =
        runTest {
            repository.addMedia(videoItem())
    ...
    @Test
    fun `getAllMedia orders items by addedAt descending`() =
        runTest {
