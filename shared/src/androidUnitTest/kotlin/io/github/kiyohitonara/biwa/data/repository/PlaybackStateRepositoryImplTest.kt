...
class PlaybackStateRepositoryImplTest {
    ...
    @Test
    fun `getPlaybackState returns null when no state exists`() =
        runTest {
    ...
    @Test
    fun `savePlaybackState persists state and getPlaybackState returns it`() =
        runTest {
    ...
    @Test
    fun `savePlaybackState preserves all fields`() =
        runTest {
    ...
    @Test
    fun `savePlaybackState preserves null ab points`() =
        runTest {
    ...
    @Test
    fun `savePlaybackState overwrites existing state for same videoId`() =
        runTest {
    ...
    @Test
    fun `savePlaybackState stores independent state per videoId`() =
        runTest {
    ...
    @Test
    fun `savePlaybackState preserves fractional playback speed`() =
        runTest {
